...
export type CreateBankIdSessionMutation = (
  ...
  & { bankId: Maybe<(
    ...
    & { sessions: Maybe<(
      ...
      & { create: (
        { __typename?: 'BankIdSession' }
        & Pick<BankIdSession, 'id' | 'status' | 'name' | 'givenName' | 'surname' | 'deviceIpAddress' | 'certNotBefore' | 'certNotAfter' | 'orderRef' | 'signature' | 'ocspResponse' | 'userVisibleData' | 'userNonVisibleData' | 'createdAt' | 'updatedAt'>
      ) }
    )> }
  )> }
);
...
export type InitSignBankIdSessionMutation = (
  { __typename?: 'Mutation' }
  & { bankId: Maybe<(
    { __typename?: 'BankIdMutation' }
    & { session: Maybe<(
...
export type SubscribeBankIdSessionSubscription = (
  { __typename?: 'Subscription' }
  & { bankIdSession: (
    { __typename?: 'BankIdSession' }
    & Pick<BankIdSession, 'id' | 'status' | 'name' | 'givenName' | 'surname' | 'deviceIpAddress' | 'certNotBefore' | 'certNotAfter' | 'orderRef' | 'signature' | 'ocspResponse' | 'userVisibleData' | 'userNonVisibleData' | 'hintCode' | 'errorCode' | 'details' | 'response' | 'completionData' | 'createdAt' | 'updatedAt'>
  ) }
);
...
export const CreateBankIdSessionDocument = gql`
  ...
  bankId {
    ...
    `;
export type CreateBankIdSessionMutationFn = ApolloReactCommon.MutationFunction<CreateBankIdSessionMutation, CreateBankIdSessionMutationVariables>;
export type CreateBankIdSessionComponentProps = Omit<ApolloReactComponents.MutationComponentOptions<CreateBankIdSessionMutation, CreateBankIdSessionMutationVariables>, 'mutation'>;

    export const CreateBankIdSessionComponent = (props: CreateBankIdSessionComponentProps) => (
      <ApolloReactComponents.Mutation<CreateBankIdSessionMutation, CreateBankIdSessionMutationVariables> mutation={CreateBankIdSessionDocument} {...props} />
    );
    
export type CreateBankIdSessionProps<TChildProps = {}> = ApolloReactHoc.MutateProps<CreateBankIdSessionMutation, CreateBankIdSessionMutationVariables> | TChildProps;
export function withCreateBankIdSession<TProps, TChildProps = {}>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
  CreateBankIdSessionMutation,
  CreateBankIdSessionMutationVariables,
  CreateBankIdSessionProps<TChildProps>>) {
    return ApolloReactHoc.withMutation<TProps, CreateBankIdSessionMutation, CreateBankIdSessionMutationVariables, CreateBankIdSessionProps<TChildProps>>(CreateBankIdSessionDocument, {
      alias: 'createBankIdSession',
      ...operationOptions
    });
};
export type CreateBankIdSessionMutationResult = ApolloReactCommon.MutationResult<CreateBankIdSessionMutation>;
export type CreateBankIdSessionMutationOptions = ApolloReactCommon.BaseMutationOptions<CreateBankIdSessionMutation, CreateBankIdSessionMutationVariables>;
export const InitSignBankIdSessionDocument = gql`
  ...
  bankId {
    ...
    `;
export type InitSignBankIdSessionMutationFn = ApolloReactCommon.MutationFunction<InitSignBankIdSessionMutation, InitSignBankIdSessionMutationVariables>;
export type InitSignBankIdSessionComponentProps = Omit<ApolloReactComponents.MutationComponentOptions<InitSignBankIdSessionMutation, InitSignBankIdSessionMutationVariables>, 'mutation'>;

    export const InitSignBankIdSessionComponent = (props: InitSignBankIdSessionComponentProps) => (
      <ApolloReactComponents.Mutation<InitSignBankIdSessionMutation, InitSignBankIdSessionMutationVariables> mutation={InitSignBankIdSessionDocument} {...props} />
    );
    
export type InitSignBankIdSessionProps<TChildProps = {}> = ApolloReactHoc.MutateProps<InitSignBankIdSessionMutation, InitSignBankIdSessionMutationVariables> | TChildProps;
export function withInitSignBankIdSession<TProps, TChildProps = {}>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
  InitSignBankIdSessionMutation,
  InitSignBankIdSessionMutationVariables,
  InitSignBankIdSessionProps<TChildProps>>) {
    return ApolloReactHoc.withMutation<TProps, InitSignBankIdSessionMutation, InitSignBankIdSessionMutationVariables, InitSignBankIdSessionProps<TChildProps>>(InitSignBankIdSessionDocument, {
      alias: 'initSignBankIdSession',
      ...operationOptions
    });
};
export type InitSignBankIdSessionMutationResult = ApolloReactCommon.MutationResult<InitSignBankIdSessionMutation>;
export type InitSignBankIdSessionMutationOptions = ApolloReactCommon.BaseMutationOptions<InitSignBankIdSessionMutation, InitSignBankIdSessionMutationVariables>;
export const SubscribeBankIdSessionDocument = gql`
  ...
  bankIdSession(id: $id) {
    ...
    `;
export type SubscribeBankIdSessionComponentProps = Omit<ApolloReactComponents.SubscriptionComponentOptions<SubscribeBankIdSessionSubscription, SubscribeBankIdSessionSubscriptionVariables>, 'subscription'>;

    export const SubscribeBankIdSessionComponent = (props: SubscribeBankIdSessionComponentProps) => (
      <ApolloReactComponents.Subscription<SubscribeBankIdSessionSubscription, SubscribeBankIdSessionSubscriptionVariables> subscription={SubscribeBankIdSessionDocument} {...props} />
    );
    
export type SubscribeBankIdSessionProps<TChildProps = {}> = ApolloReactHoc.DataProps<SubscribeBankIdSessionSubscription, SubscribeBankIdSessionSubscriptionVariables> | TChildProps;
export function withSubscribeBankIdSession<TProps, TChildProps = {}>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
  SubscribeBankIdSessionSubscription,
  SubscribeBankIdSessionSubscriptionVariables,
  SubscribeBankIdSessionProps<TChildProps>>) {
    return ApolloReactHoc.withSubscription<TProps, SubscribeBankIdSessionSubscription, SubscribeBankIdSessionSubscriptionVariables, SubscribeBankIdSessionProps<TChildProps>>(SubscribeBankIdSessionDocument, {
      alias: 'subscribeBankIdSession',
      ...operationOptions
    });
};
export type SubscribeBankIdSessionSubscriptionResult = ApolloReactCommon.SubscriptionResult<SubscribeBankIdSessionSubscription>;